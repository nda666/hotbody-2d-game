...
export default class Player {
  ...
  preload() {
    ...
    characterAssets;
    const skinPath = (
      characterAssets[`../assets/character/skin/${skinName}`] as any
    ).default;
    console.log(
      characterAssets[`../assets/character/skin/${skinName}`],
      characterAssets
    );
    const pantPath = (
      characterAssets[`../assets/character/clothing/${pantName}`] as any
    ).default;
    ...
    this.scene.load.spritesheet("pant", pantPath, {
      frameWidth: 80,
      frameHeight: 64,
    });
  }
