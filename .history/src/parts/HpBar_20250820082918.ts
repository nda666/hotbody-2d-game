...
export default class HpBar {
  ...
  static preload(scene: Phaser.Scene) {
    scene.load.image("hpBarContainerImage", hpBarContainerImage);
  ...
  constructor(scene: Phaser.Scene, x: number, y: number, maxHp: number) {
    ...
    // gambar warna hp (karena tidak bisa menggunakan asset warna, gunakan graphics
