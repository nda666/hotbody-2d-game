...
import { characterAssets } from "./player";
...
export default class Hair {
  ...
  preload() {
    const spritePath = characterAssets.hair[
      `../assets/character/${this.gender}_hair/${this.spriteName}`
    ] as any;

    this.scene.load.spritesheet("hair", spritePath, {
      frameWidth: 80,
      frameHeight: 64,
    });
  }
