...
export default class Player {
  ...
  create() {
    ...
    const skinPart = this.bodyParts.find((p) => p.category === "skin");
  ...
  update() {
    ...
    this.bodyParts.forEach((part) => {
      if (part.sprite && part.category !== "skin") {
    ...
    this.bodyParts.forEach((part) => {
      if (part.category !== "skin" && part.sprite) {
        part.sprite.play(`${part.category}_${state}`, true);
      }
    });
  }
}
