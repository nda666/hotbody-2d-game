...
export default class Player {
  ...
  private createAnimations(scene: Phaser.Scene) {
    ...
    this.pant.createAnimations();
    this.hair.createAnimations();
    this.clothing.createAnimations();
  }
  ...
  update() {
    ...
    this.clothing.sprite.x = this.sprite.x;
    this.clothing.sprite.y = this.sprite.y;
    this.clothing.sprite.flipX = this.sprite.flipX;
    ...
    if (!onGround) {
      ...
      if (left?.isDown || right?.isDown) {
        ...
        this.clothing.sprite.play("clothing_walk", true);
      } else {
        this.sprite.play("idle", true);
        this.pant.sprite.play("pant_idle", true);
        this.hair.sprite.play("hair_idle", true);
        this.clothing.sprite.play("clothing_idle", true);
      }
    }
  }
}
