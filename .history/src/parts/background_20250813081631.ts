export default class Background {
  ...
  static preload(scene: Phaser.Scene) {
    scene.load.image(
      "bg1",
      "assets/world/oak_woods/background/background_layer_1.png"
    );
    scene.load.image(
      "bg2",
      "assets/world/oak_woods/background/background_layer_2.png"
    );
    scene.load.image(
      "bg3",
      "assets/world/oak_woods/background/background_layer_3.png"
    );
  }
