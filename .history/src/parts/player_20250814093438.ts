...
import { characterAssets, getCharacterAsset } from "../lib/AssetLoader";
import Hair from "./hair";

const skinAssets = characterAssets.skins;
const clothAssets = characterAssets.clothing;
...
export default class Player {
  ...
  static preload(scene: Phaser.Scene) {
    ...
    const pantName = "Purple Shirt v2";

    console.log(getCharacterAsset("clothing", "Purple Shirt v2.png"));

    console.log(skinAssets);
    const skinPath = skinAssets[`../assets/character/skin/${skinName}`] as any;
    const pantPath = clothAssets[
