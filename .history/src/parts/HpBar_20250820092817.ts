...
export default class HpBar {
  ...
  constructor(
    ...
    this.manaBarHeight = barHeight * (30 / 100);
    this.manaBarWidth = barWidth - barHeight + 20;
    ...
    this.manaBar = scene.add.image(x + 49, y + 55, "manaBarImage");
    this.manaBar
  ...
  setHp(value: number) {
    ...
    this.currentMana = Phaser.Math.Clamp(value, 0, this.maxHp);
    this.draw();
  }
