...
export default class Stage1 extends Phaser.Scene {
  ...
  create() {
    ...
    / bikin kamera follow player
this.cameras.main.startFollow(this.player);

// opsi tambahan biar smooth
this.cameras.main.setLerp(0.1, 0.1); // semakin kecil semakin halus

// kalau mau kasih batas kamera sesuai ukuran map
