...
import hair from './assets/character/Male Clothing/Blue Shirt v2.png';
...
class MyScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.anims.create({
      key: "hair_walk",
      frames: this.anims.generateFrameNumbers("hair", { start: 20, end: 27 }),
      frameRate: 10,
      repeat: -1,
    });
    this.anims.create({
      key: "hair_jump",
      frames: this.anims.generateFrameNumbers("hair", { start: 30, end: 33 }),
      frameRate: 10,
      repeat: 0,
    });
    this.anims.create({
      key: "hair_fall",
      frames: this.anims.generateFrameNumbers("hair", { start: 40, end: 43 }),
      frameRate: 10,
      repeat: 0,
    });
  ...
  update() {
    ...
    this.hair.y = this.player.y;
    this.hair.flipX = this.player.flipX;
    // Animasi
    if (!onGround) {
