...
import hair from "./assets/character/hair/Male Hair5.png";
import pants from "./assets/character/Male Clothing/Green Pants.png";
...
class MyScene extends Phaser.Scene {
  ...
  pants!: Phaser.Physics.Arcade.Sprite;
  ...
  preload() {
    ...
    this.load.spritesheet("pants", pants, {
      frameWidth: 80,
      frameHeight: 64,
    });
  ...
  create() {
    ...
    this.pants = this.add
      .sprite(this.player.x, this.player.y, "pants")
      .setDepth(11)
      .setScale(6);
    ...
    this.anims.create({
      key: "pants_idle",
      frames: this.anims.generateFrameNumbers("pants", { start: 0, end: 0 }),
      frameRate: 6,
      repeat: -1,
    });
    this.anims.create({
      key: "pants_walk",
      frames: this.anims.generateFrameNumbers("pants", { start: 20, end: 27 }),
      frameRate: 10,
      repeat: -1,
    });
    ...
    this.anims.create({
      key: "pants_jump",
      frames: this.anims.generateFrameNumbers("pants", { start: 30, end: 33 }),
      frameRate: 10,
      repeat: 0,
    });
    ...
    this.anims.create({
      key: "pants_fall",
      frames: this.anims.generateFrameNumbers("pants", { start: 40, end: 43 }),
      frameRate: 10,
      repeat: 0,
    });
  ...
  update() {
    ...
    if (this.cursors.left.isDown) {
      ...
      this.bg2.tilePositionX -= speed * 0.3;
      this.bg3.tilePositionX -= speed * 0.5;
    }
    // Kanan
    ...
    this.pants.x = this.player.x;
    this.pants.y = this.player.y;
    this.pants.flipX = this.player.flipX;
    // Animasi
    if (!onGround) {
      if (this.player.body.velocity.y < 0) {
        this.player.play("jump", true);
        this.pants.play("pants_jump", true);
      } else {
        this.player.play("fall", true);
        this.pants.play("pants_fall", true);
      }
    } else {
      if (this.cursors.left.isDown || this.cursors.right.isDown) {
        this.player.play("walk", true);
        this.pants.play("pants_walk", true);
      } else {
        this.player.play("idle", true);
        this.pants.play("pants_idle", true);
      }
    }
  }
}
